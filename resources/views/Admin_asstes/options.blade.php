                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('admin/edit_option/'.$header->id)}}"  class="btn btn-primary ml-lg-1 ml-md-1 mt-1">Edit</a>

                                    <a href="{{url('admin/delete_option/'.$header->id)}}" class="btn btn-danger ml-lg-1 ml-md-1 mt-1">Delete</a>
