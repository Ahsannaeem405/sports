                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('admin/edit_user/'.$header->id)}}"  class="btn btn-primary ml-lg-1 ml-md-1 mt-1">Edit</a>

                                    <a href="{{url('admin/delete_user/'.$header->id)}}" onclick="return confirm('Are you sure you want to delete this User?');" class="btn btn-danger ml-lg-1 ml-md-1 mt-1">Delete</a>
